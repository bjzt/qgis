          ...
          <el-row>
            <el-col :xs="24" :xl="18" :lg="18" :sm="18" :md="24">
              ...
              <el-form-item label="结算方式" label-width="120px">
                <el-switch v-model="flag" active-text="按时间计费" inactive-text="按点按次计费"></el-switch>
              </el-form-item>
        ...
        <div>
          <el-row>
            <el-col :xs="24" :xl="18" :sm="18" :md="24">
              ...
              <el-form-item label-width="120px">
                <a
                  v-if="downloadPath != null"
                  :href="`${baseUrl}/file/upload/download?filePath=${downloadPath}`"
                >
    ...
    item1: {
      ...
      handler(newV) {
        switch (this.item1.zb) {
          case "xyh":
            this.name = "点名,x,y,h.txt / 点名,,y,x,h.dat";
            break;
          case "XYZ":
            this.name = "点名,X,Y,Z.txt";
            break;
          case "BLH":
            this.name = `点名,B(${this.item1.dd}),L(${this.item1.dd}),H,未修正的天线高.txt`;
            break;
        }
      }
    },
